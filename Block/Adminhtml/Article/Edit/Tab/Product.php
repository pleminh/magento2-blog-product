 ...
 * @method array|null getArticleProducts()
 * @method Product setArticleProducts(array $products)
 */
class Product extends ExtendedGrid implements TabInterface
{
    ...
    {
        $selected = $this->getArticle()->getProductsPosition();
    ...
    public function getGridUrl()
    {
        return $this->getUrl(
            '*/*/productsGrid',
            [
                'article_id' => $this->getArticle()->getId()
            ]
        );
    }
    ...
    {
        return $this->coreRegistry->registry('gemtoo_blog_article');
    }
    ...
    {
        return $this->getUrl('gemtoo_blog/article/products', ['_current' => true]);
    }
